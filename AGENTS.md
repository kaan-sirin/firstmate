...
config/max-active-workers     optional primary-authoritative per-home limit for concurrently live crew endpoints; LOCAL, gitignored, inherited into secondmate homes; see docs/configuration.md "Worker capacity"
