...
state/               runtime records and signals; gitignored
  ...
  <id>.meta          task metadata; each producer script's header owns its exact fields and mutation contract, with docs/configuration.md routing operator-facing backend and trace-context details; a mode=fast-repair ship records fast_repair=eligible for the watcher progress cadence (docs/fast-repair.md)
