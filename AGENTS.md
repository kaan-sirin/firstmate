...
config/max-active-workers     optional primary-authoritative per-host limit for concurrently live crew endpoints across local secondmate homes; LOCAL, gitignored, inherited into secondmate homes; see docs/configuration.md "Worker capacity"
