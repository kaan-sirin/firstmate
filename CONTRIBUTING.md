...
Local `.no-mistakes/` state stays out of this repo; `.no-mistakes.yaml` stores gate test evidence in the repo and pins the gate's lint command to `bin/fm-lint.sh`, matching the Linux CI lint job.
