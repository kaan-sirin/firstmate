...
That link stores optional reply-platform context and a validated source thread URL, so Discord-originated follow-ups keep Discord's larger message budget after the inbox file has been drained and the dashboard can link captain actions to their source thread.
