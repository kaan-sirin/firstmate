...
Cursor Agent CLI runs crewmate and scout work.
...
This lets away-mode escalation deliver to a Cursor crew: `bin/fm-supervise-daemon.sh` needs an affirmatively-empty composer before it types, and it needs no Cursor-specific branch once the reader is correct.
